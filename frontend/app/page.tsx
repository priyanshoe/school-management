...
export default function Home() {
  ...
  return (
    <div id="main" className="h-screen w-full flex">
      {/* temp button */}
      <Button onClick={() => router.push("lists/subjects")}>Temp</Button>
      ...
      >
        ...
        <div className="flex gap-2 items-center">
          <Label htmlFor="email" className="w-25 text-end ">
            Email
          </Label>
          <Input
            type="email"
        ...
        <div className="flex gap-2 items-center">
          <Label htmlFor="password" className="w-25 text-end ">
            Password
          </Label>
          <Input
            type="password"
      ...
      >
        ...
        <div className="flex gap-4 items-center">
          <Label htmlFor="email" className="w-20 flex justify-end">
            Email
          </Label>
          <Input
            type="email"
        ...
        <div className="flex gap-4 items-center">
          <Label htmlFor="phone" className="w-20 flex justify-end">
            Phone
          </Label>
          <Input
            type="text"
        ...
        <div className="flex gap-4 items-center">
          <Label htmlFor="address" className="w-20 flex justify-end">
            Address
          </Label>
          <Input
            type="text"
        ...
        <div className="flex gap-4 items-center">
          <Label htmlFor="photo" className="w-25 flex justify-end">
            Photo URL
          </Label>
          <Input
            type="text"
            ...
            onChange={(e) =>
              setSignUpData({ ...signUpData, photo: e.target.value })
            }
          ></Input>
        </div>
        <div className="flex gap-4 items-center">
          <Label htmlFor="bio" className="w-20 flex justify-end">
            Bio
          </Label>
          <Input
            type="text"
        ...
        <div className="flex gap-4 items-center">
          <Label htmlFor="bloodgroup" className="w-32 flex justify-end">
            Blood Group
          </Label>
          <Input
            type="text"
            ...
            onChange={(e) =>
              setSignUpData({ ...signUpData, blood_group: e.target.value })
            }
          />
        </div>
        <DatePicker />
