...
async function createLesson(req,res){
    try{
        ...
        return res.status(201).json({message:"Lesson data created", data:create.insertId})
    }catch(err){
...
async function updateLesson(req,res){
    try{
        ...
        if(update.affectedRows===0) return res.status(404).json({message:"Lesson not found"})
...
async function deleteLesson(req,res){
    try{
        ...
        if(deleted.affectedRows===0) return res.status(404).json({message:"Lesson not found"})
